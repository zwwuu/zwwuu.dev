      ...
      <form name="contact" method="POST" data-netlify={'true'} netlify-honeypot="honeypot" onSubmit={handleSubmit}>
        <Stack>
          <div>
            ...
            <input type="text" id="name" name="name" autoComplete="name" required="true" className={styles.input} />
          </div>
          <div>
            <label className={styles.label} htmlFor={'email'}>
              Email
            </label>
            <input type="email" id="email" name="email" autoComplete="email" required="true" className={styles.input} />
          </div>
          <div>
